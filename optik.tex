...
\usepackage{geometry}
\usepackage{pgfplots} 
\usepackage{tikz} % tikz kütüphanesini ekliyoruz
\geometry{
  top=0.8in,            
  inner=0.5in,
  outer=0.5in,
...
\definecolor{titlecolor}{HTML}{0022CC} % Başlık rengi tanımı

% Başlık biçimlendirmeleri
\titleformat{\section}
  {\color{titlecolor}\Large\bfseries\justifying} % Stil: Büyük ve kalın yazı, renkli
  {} % Başlık numarasını göstermiyoruz
  {0pt} % Numara ve metin arasında boşluk yok
  {\hspace*{-\leftskip}} % Başlığı tamamen sola yaslar
  [\titlerule] % Alt çizgi eklenmez

\titleformat{\subsection}
  {\color{titlecolor}\large\bfseries} % Stil: Orta boy ve kalın yazı, renkli
  {} % Alt başlık numarasını göstermiyoruz
  {0pt} % Numara ve metin arasında boşluk yok
  {\hspace*{-\leftskip}} % Alt başlığı tamamen sola yaslar

\titleformat{\subsubsection}
  {\color{titlecolor}\normalsize\bfseries} % Stil: Normal boyut ve kalın yazı, renkli
  {} % Alt alt başlık numarasını göstermiyoruz
  {0pt} % Numara ve metin arasında boşluk yok
  {\hspace*{-\leftskip}} % Alt alt başlığı tamamen sola yaslar
...
\chead[C]{
     ...
     \centering
     \textcolor{white}{İstanbul Üniversitesi Fen Fakültesi}
     \end{minipage}}}
         &
        \centering
         \tiny{ Lisans Fizik Programı\\
          Akademik Yıl: 2024B\\}
          \tabularnewline
          \end{tabular}%
    }
